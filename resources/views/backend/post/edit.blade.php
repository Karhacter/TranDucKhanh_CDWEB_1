...
@section('content')
    <div class="content" style="padding-left: 20px;padding-right: 20px;">
        <section class="content-header my-2">
            <h1 class="d-inline text-primary">Cập nhật bài viết</h1>
            <div class="text-end">
                    ...
                    <div class="col-md-9">
                        ...
                        <div class=" mb-3">
                            ...
                            <input type="text" name="slug" placeholder="Nhập tên slug"
                                value="{{ old('slug', $post->slug) }}" class="form-control">
                            @error('slug')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea name="detail" rows="7" class="form-control" placeholder="Nhập chi tiết">{{ old('detail', $post->detail) }}</textarea>
                            @error('detail')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
