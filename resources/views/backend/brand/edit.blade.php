...
@section('content')
    <div class="content" style="padding-left: 20px;padding-right: 20px;">
        <section class="content-header my-2">
            <h1 class="d-inline text-success">Cập nhật thuong hiệu</h1>
            <div class="text-end">
        ...
        <form action="{{ route('admin.brand.update', ['id' => $row->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="text-end">
            ...
            <section class="content-body my-2">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" value="{{ old('name', $row->name) }}" id="name" value=""
                        class="form-control">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="slug" id="slug" value="{{ old('slug', $row->slug) }}"
                        class="form-control">
                </div>
                <div class="mb-3">
                    <label><strong>Mô tả</strong></label>
                    <textarea name="description" rows="7" class="form-control">{{ old('description', $row->description) }}</textarea>
                </div>
